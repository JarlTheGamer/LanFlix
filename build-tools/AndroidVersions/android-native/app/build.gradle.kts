...
android {
    namespace = "com.lanflix.android"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.lanflix.android"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // Video Player (Netflix uses ExoPlayer)
    ...
    // TV Support (Leanback for Android TV)
